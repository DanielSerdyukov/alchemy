...
public class TableMakerTest {
    ...
    public void testGeneratedSource() throws Exception {
        final JavaFileObject generated = JavaFileObjects.forSourceLines("rxsqlite.test.Foo$$Table", Arrays.asList(
                ...
                "    object.mBool = row.getColumnLong(4) > 0;",
                "    object.mFloat = (float) row.getColumnDouble(5);",
                "    object.mString = row.getColumnString(6);",
                "    object.mBytes = row.getColumnBlob(7);",
                "    object.mDate = mTypes.getValue(row, 8, java.util.Date.class);\n",
                "    object.mEnumType = mTypes.getEnumValue(row, 9, rxsqlite.test.Foo.EnumType.class);",
                "    return object;",
                "  }",
