...
class CustomTypes {
    ...
    static ClassName className() {
        return ClassName.get(Consts.PACKAGE_NAME, CLASS_NAME);
    }

    static JavaFile brewJava() {
        final TypeSpec.Builder spec = TypeSpec.classBuilder(CLASS_NAME)
                .addModifiers(Modifier.PUBLIC)
                .addField(Consts.RXS_TYPES, "mTypes", Modifier.PRIVATE, Modifier.FINAL)
                .addMethod(MethodSpec.constructorBuilder()
                        .addParameter(Consts.RXS_TYPES, "types")
